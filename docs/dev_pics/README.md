...
| 004 | 2026-08-21 | Drag nedåt byter stil — indikatorn mitt i gesten, över tröskeln | Lokal dev-server, `412×915` (`isMobile`), syntetiska touch-events | `004_drag_nedat_ny_stil/drag_mobil.png` |
